;(() => {
  window.addEventListener('DOMContentLoaded', () => {
    ...
    searchBtn.addEventListener('click', () => {
      searchBtn
        .closest('.header-icons__item')
        .querySelector('svg').style.display = 'none'
      searchBtn
        .closest('.header-icons__item')
        .querySelector('.header-icons__search').style.display = 'block'
    })
    document.addEventListener('click', (e) => {
      ...
      if (
        ...
        searchBtn
          .closest('.header-icons__item')
          .querySelector('svg').style.display = 'block'
        searchBtn
          .closest('.header-icons__item')
          .querySelector('.header-icons__search').style.display = 'none'
      }
    })
  })
})()
